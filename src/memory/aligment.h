...
template<typename T>
constexpr auto avx_allocate_aligned_memory = allocate_aligned_memory<T, Alignment::AVX>;

// Alias function allocate_aligned_memory<T, Alignment::SSE>
template<typename T>
constexpr auto sse_allocate_aligned_memory = allocate_aligned_memory<T, Alignment::SSE>;
